            ...
            <Paper sx={{ p: 3 }}>
                ...
                <Stack spacing={2} sx={{ mb: 2 }}>
                    <Stack direction={{ xs: "column", md: "row" }} spacing={2}>
                        <TextField label="Modelo" value={name} onChange={(e) => setName(e.target.value)} fullWidth />
                        <FormControlLabel
                            control={
                    ...
                    <Stack direction={{ xs: "column", md: "row" }} spacing={2}>
                        ...
                        <Button variant="outlined" onClick={() => { setEditId(null); setName(""); setIsActive(true); }}>Limpiar</Button>
                    ...
                    <TableBody>
                        {items.map((machine) => (
                            <TableRow key={machine.id}>
                                ...
                                <TableCell>{machine.is_active ? "Activo" : "Inactivo"}</TableCell>
