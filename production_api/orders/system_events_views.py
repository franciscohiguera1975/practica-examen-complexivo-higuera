...
from .mongo_serializers import SystemEventSerializer
...
def system_events_list_create(request):
    ...
    serializer = SystemEventSerializer(data=request.data)
...
def system_events_detail(request, id: str):
    ...
    if request.method in ["PUT", "PATCH"]:
        serializer = SystemEventSerializer(data=request.data, partial=(request.method == "PATCH"))
        serializer.is_valid(raise_exception=True)
