...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable onPress={() => navigation.navigate("SystemEvents")} style={styles.btn}>
        <Text style={styles.btnText}>System Events (list/create/delete)</Text>
      </Pressable>

      <Pressable onPress={() => navigation.navigate("OperationLogs")} style={styles.btn}>
        <Text style={styles.btnText}>Operation Logs (2 selects + create/delete)</Text>
      </Pressable>
